...
### This code also works but I recommend using latest code [Click here](https://github.com/linux-jin/SELF-TG-FILESTREAM-BOT-pro) to deploy it
### If it doesnt matter keep scrolling
![GitHub repo size](https://img.shields.io/github/repo-size/linux-jin/SELF-TG-FILESTREAM-BOT?color=yellow)
...
![GitHub](https://img.shields.io/github/license/linux-jin/SELF-TG-FILESTREAM-BOT)
...
![GitHub commit activity](https://img.shields.io/github/commit-activity/m/linux-jin/SELF-TG-FILESTREAM-BOT)
<h1 align="center">SELF-TG-FILESTREAM-BOT</h1>
<p align="center">
  <img src="https://socialify.git.ci/linux-jin/SELF-TG-FILESTREAM-BOT/image?description=1&descriptionEditable=A%20very%20fast%20file%20streaming%20bot%20used%20for%20streaming%20and%20downloading%20movies&font=Source%20Code%20Pro&forks=1&issues=1&language=1&logo=https%3A%2F%2Fuser-images.githubusercontent.com%2F88939380%2F137127129-a86fc939-2931-4c66-b6f6-b57711a9eab7.png&owner=1&pattern=Circuit%20Board&pulls=1&stargazers=1&theme=Dark" alt="Cover Image" width="650">
...
## `Star and fork the repo Before deploying`
   ...
   <a href="https://github.com/linux-jin/SELF-TG-FILESTREAM-BOT/issues">Report a Bug</a>
    |
    <a href="https://github.com/linux-jin/SELF-TG-FILESTREAM-BOT/issues">Request Feature</a>
  </p>
...
```py
git clone https://github.com/linux-jin/SELF-TG-FILESTREAM-BOT
cd SELF-TG-FILESTREAM-BOT
